...
- **Do not fake method choice**: current ScrnaClaw `sc-qc` exposes one public QC path, `qc_metrics`; do not describe multiple QC backends unless they are truly implemented.
