...
- **Respect implementation limits**: do not promise histology-aware SpaGCN in the current ScrnaClaw workflow, and do not treat all domain methods as having the same assumptions.
