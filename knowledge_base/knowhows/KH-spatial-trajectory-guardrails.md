...
- **Preserve the output contract**: scalar pseudotime summaries, trajectory-gene tables, and method-specific trajectory artifacts should be exported through the standard ScrnaClaw layout.
