...
- **Do not invent unsupported knobs**: official LIANA and CellChat workflows expose extra filters such as expression cutoffs and permutation settings, but the current ScrnaClaw wrapper does not expose them.
