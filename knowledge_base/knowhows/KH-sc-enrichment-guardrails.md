...
- **Do not overclaim thresholding**: the current wrapper scores AUCell activity but does not expose automatic threshold assignment as a public ScrnaClaw control.
