...
- **State the graph contract before running**: for graph-based methods, report `stats_n_neighs`, `stats_n_rings`, and whether ScrnaClaw will reuse an existing graph or rebuild it.
