...
- **Explain the output contract**: after a successful run, users should understand that `processed.h5ad` is the file to pass into downstream ScrnaClaw scRNA skills.
