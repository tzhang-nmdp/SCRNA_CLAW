...
- **Respect reference constraints**: current ScrnaClaw RCTD wrapper drops cell types with fewer than 25 reference cells before running spacexr; this should be explained instead of hidden.
...
- **Preserve the standardized output contract**: the canonical ScrnaClaw output is `tables/proportions.csv` plus derived summaries and reproducibility files, regardless of backend.
