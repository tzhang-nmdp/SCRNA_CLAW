...
- **Do not overclaim platform support**: `platform` is a reporting label. It does not switch the upstream algorithm, and it should not be described as if ScrnaClaw implements separate raw-processing methods for Visium, Slide-seq, or other barcode-coordinate assays.
