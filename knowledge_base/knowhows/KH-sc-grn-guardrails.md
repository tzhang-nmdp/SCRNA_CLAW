...
- **Do not invent hidden database knobs**: pySCENIC exposes many resource-specific details, but the current ScrnaClaw wrapper only exposes a compact resource-selection surface.
