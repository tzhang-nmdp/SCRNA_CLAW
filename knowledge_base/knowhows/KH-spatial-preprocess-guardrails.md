...
- **Use method-correct language**: current ScrnaClaw `spatial-preprocess` exposes one implemented workflow, `scanpy_standard`; do not imply that multiple preprocessing backends already exist unless they are truly implemented.
