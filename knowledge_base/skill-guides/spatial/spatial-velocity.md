...
title: ScrnaClaw Skill Guide — Spatial Velocity
...
# ScrnaClaw Skill Guide — Spatial Velocity
...
- how to explain velocity pseudotime, latent time, and uncertainty without
  overstating them
- how to use ScrnaClaw's Python gallery and optional R visualization layer
  correctly
...
- ScrnaClaw always rebuilds the shared velocity preprocessing contract for the
...
Current ScrnaClaw exports include:
...
1. **Python standard gallery**
   - canonical ScrnaClaw analysis layer
