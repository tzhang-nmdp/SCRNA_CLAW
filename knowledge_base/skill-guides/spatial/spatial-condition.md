...
title: ScrnaClaw Skill Guide — Spatial Condition Comparison
...
# ScrnaClaw Skill Guide — Spatial Condition Comparison
...
- **Cluster labels**: `cluster_key` should already exist or ScrnaClaw will
...
Current ScrnaClaw `spatial-condition` separates visualization into two layers:
