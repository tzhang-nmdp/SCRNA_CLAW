...
title: ScrnaClaw Skill Guide — Spatial Raw Processing
...
# ScrnaClaw Skill Guide — Spatial Raw Processing
...
## Step 3: Explain How ScrnaClaw Finds `st_pipeline`

Current resolution order is:
1. `--stpipeline-repo <repo_root>` or `SCRNA_CLAW_ST_PIPELINE_REPO`
...
About to run spatial raw processing
  ...
  Next ScrnaClaw step: spatial-preprocess
...
- describe `raw_counts.h5ad` as the canonical ScrnaClaw handoff object
