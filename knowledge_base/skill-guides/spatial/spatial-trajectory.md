...
title: ScrnaClaw Skill Guide — Spatial Trajectory
...
# ScrnaClaw Skill Guide — Spatial Trajectory
...
- Scanpy's `palantir_results()` returns a Palantir results object; current ScrnaClaw writes pseudotime / entropy back into AnnData instead of assuming Scanpy stores them automatically.
...
Current ScrnaClaw `spatial-trajectory` separates visualization into two layers:
