...
title: ScrnaClaw Skill Guide — SC Ambient Removal
...
# ScrnaClaw Skill Guide — SC Ambient Removal
...
- `simple` is an ScrnaClaw fallback, not an official CellBender/SoupX equivalent
...
- do not write `total-droplets-included` as a current ScrnaClaw public parameter
...
- describe `corrected.h5ad` as ScrnaClaw's downstream-ready export, not CellBender's native primary matrix file
