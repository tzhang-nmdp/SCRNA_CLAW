...
title: ScrnaClaw Skill Guide — SC QC
...
output interpretation. It is not a claim that ScrnaClaw already implements all
...
5. render the standard ScrnaClaw QC gallery through the shared single-cell `_lib/viz` layer
6. export tables, figure-data CSVs, report, result JSON, AnnData, README, and reproducibility files

Current ScrnaClaw `sc-qc` does **not**:
