...
title: ScrnaClaw Skill Guide — scRNA Quick Start
...
# ScrnaClaw Skill Guide — scRNA Quick Start
...
- if there is only one obvious reference in the right directory, ScrnaClaw can auto-detect it
...
- ScrnaClaw should guide users to install these tools and place references locally, but should not silently mutate the user's environment during normal skill execution.
