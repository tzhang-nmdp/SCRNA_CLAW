...
title: ScrnaClaw Skill Guide — SC Batch Integration
...
# ScrnaClaw Skill Guide — SC Batch Integration
...
- **Input contract**:
  - if the `.h5ad` was not standardized by ScrnaClaw, recommend `sc-standardize-input` first for more stable downstream behavior
- **Batch column**:
