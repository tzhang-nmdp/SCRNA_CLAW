...
title: ScrnaClaw Skill Guide — SC Cell Communication
...
# ScrnaClaw Skill Guide — SC Cell Communication
...
- the built-in path is a lightweight ScrnaClaw baseline, not a full external method
...
Important warnings:
- do not expose LIANA `expr_prop`, `min_cells`, or CellChat internal model parameters as current public ScrnaClaw knobs
