...
title: ScrnaClaw Skill Guide — SC Doublet Detection
...
# ScrnaClaw Skill Guide — SC Doublet Detection
...
- If users ask whether ScrnaClaw already removed the cells, answer clearly: **no, it only annotated them**
