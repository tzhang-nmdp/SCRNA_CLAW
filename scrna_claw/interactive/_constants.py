"""Shared constants for ScrnaClaw interactive CLI/TUI."""
...
WELCOME_SLOGANS = [
    ...
    "Science doesn't sleep. Neither does ScrnaClaw.",
...
# ScrnaClaw ASCII art logo (compact version)
LOGO_LINES = (
    r" ███████╗ ██████╗██████╗ ███╗   ██╗ █████╗         ██████╗██╗      █████╗ ██╗    ██╗",
    r" ██╔════╝██╔════╝██╔══██╗████╗  ██║██╔══██╗       ██╔════╝██║     ██╔══██╗██║    ██║",
    r" ███████╗██║     ██████╔╝██╔██╗ ██║███████║       ██║     ██║     ███████║██║ █╗ ██║",
...
SLASH_COMMANDS: list[tuple[str, str]] = [
    ...
    ("/skills",          "List all ScrnaClaw skills (optional: /skills <domain>)"),
    ...
    ("/help",            "Show this help"),
    ("/exit",            "Quit ScrnaClaw (aliases: /quit, /q)"),
]
