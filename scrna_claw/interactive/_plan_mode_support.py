...
def _build_generic_analysis_tasks() -> list[TaskRecord]:
    return [
        ...
        TaskRecord(
            ...
            description="Choose the best ScrnaClaw skill or custom method, with key parameters and fallback path.",
            owner="assistant",
...
def _build_skill_creation_tasks() -> list[TaskRecord]:
    return [
        ...
        TaskRecord(
            ...
            description="Create or refactor the skill structure so it matches ScrnaClaw architecture cleanly.",
            owner="assistant",
