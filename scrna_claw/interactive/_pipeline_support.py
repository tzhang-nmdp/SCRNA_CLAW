...
from scrna_claw.agents.pipeline import PIPELINE_STAGE_IDS, PipelineState
from scrna_claw.agents.pipeline_result import PipelineRunResult, normalize_pipeline_result
...
from scrna_claw.agents.plan_validation import (
    PlanValidationResult,
    resolve_plan_validation_result,
)
from scrna_claw.interactive._history_support import (
    build_research_history_messages as _build_research_history_messages,
)
from scrna_claw.runtime.events import EVENT_PLAN_APPROVED, EVENT_TASK_COMPLETED
from scrna_claw.runtime.hook_payloads import PlanHookPayload
...
def _build_hook_runtime(
    ...
    if hook_runtime is not None:
        return hook_runtime
    if not str(scrna_claw_dir or "").strip():
        return None
    return build_default_lifecycle_hook_runtime(scrna_claw_dir)
...
def build_approve_plan_command_view(
    ...
    *,
    ...
    runtime = _build_hook_runtime(scrna_claw_dir, hook_runtime)
