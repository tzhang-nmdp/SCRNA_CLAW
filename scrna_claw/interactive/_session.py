"""Lightweight SQLite session persistence for ScrnaClaw interactive CLI.

Does NOT depend on LangGraph — uses aiosqlite directly.
Sessions are stored in ~/.config/scrna_claw/sessions.db
"""
...
def get_config_dir() -> Path:
    """Return ~/.config/scrna_claw, creating it if absent."""
...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    agent_name  TEXT NOT NULL DEFAULT 'ScrnaClaw',
