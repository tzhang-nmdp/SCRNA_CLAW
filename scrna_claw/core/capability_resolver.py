"""Unified capability resolution for ScrnaClaw chat and automation flows.
...
try:
    from scrna_claw.loaders import detect_domain_from_path
...
def resolve_capability(
    ...
    *,
    ...
    if not candidates or candidates[0].score < 3.0:
        ...
        missing = ["no existing ScrnaClaw skill sufficiently matches the requested task"]
        if web_requested:
    ...
    if skill_creation_requested:
        reasoning.append("query explicitly asks for a reusable ScrnaClaw skill scaffold")
