"""Skill interface contract for ScrnaClaw analysis skills.
...
Usage for static checking::
    ...
    from scrna_claw.core.skill_protocol import SkillModule
...
class SkillModule(Protocol):
    """Expected interface for an ScrnaClaw skill module.
...
def validate_skill_module(script_path: Path) -> ValidationResult:
    """Validate a skill script against the ScrnaClaw conventions.
