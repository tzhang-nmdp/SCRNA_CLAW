"""
ScrnaClaw Memory — Unified graph-based memory system.
...
Usage (lazy init):
    ...
    from scrna_claw.memory import get_graph_service, get_db_manager
...
def _ensure_initialized():
    ...
    database_url = os.getenv("SCRNA_CLAW_MEMORY_DB_URL")
