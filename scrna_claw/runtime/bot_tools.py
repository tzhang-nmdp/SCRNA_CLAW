...
def build_bot_tool_specs(context: BotToolContext) -> list[ToolSpec]:
    specs = [
        ToolSpec(
            name="scrna_claw",
            description=(
                f"Run an ScrnaClaw multi-omics analysis skill. Available canonical skills: {context.skill_desc_text}. "
                ...
                "rerun this tool with `auto_prepare=true` so ScrnaClaw performs the recommended "
                ...
                "properties": {
                    ...
                    "batch_key": {
                        ...
                        "description": (
                            ...
                            "If omitted for sc-batch-integration, ScrnaClaw will inspect the AnnData object "
        ...
        ToolSpec(
            name="save_file",
            description="Save a file that was sent via messaging to a specific folder. Default: ScrnaClaw data/ directory.",
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolSpec(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "destination_folder": {"type": "string", "description": "Folder path (absolute). Default: ScrnaClaw data/."},
                },
        ...
        ToolSpec(
            ...
            description=(
                "Resolve whether a user request is fully covered by an existing ScrnaClaw skill, "
        ...
        ToolSpec(
            ...
            description=(
                "Create a new ScrnaClaw-native skill scaffold under skills/<domain>/<skill-name>/ "
                "using templates/SKILL-TEMPLATE.md as the base structure. Use this only when the user "
                "explicitly wants a reusable new skill added to ScrnaClaw. If a previous "
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "domain": {
                        ...
                        "description": "Target ScrnaClaw domain for the new skill. Optional if it can be inferred from a promoted autonomous analysis.",
                    },
                    "summary": {
                        "type": "string",
        ...
        ToolSpec(
            ...
            description=(
                "Execute custom analysis code in a restricted Jupyter notebook when an existing ScrnaClaw skill "
        ...
        ToolSpec(
            ...
            description=(
                ...
                "analysis directions. Do NOT call scrna_claw for open-ended exploratory queries."
            ),
            parameters={
                "type": "object",
                "properties": {
