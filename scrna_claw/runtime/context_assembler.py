...
from scrna_claw.core.registry import ensure_registry_loaded
...
LOGGER = logging.getLogger("scrna_claw.runtime.context")
...
async def assemble_chat_context(
    *,
    ...
    if workspace or pipeline_workspace:
        ...
        if loader is None:
            from scrna_claw.memory.scoped_memory_select import load_scoped_memory_context as _load_scoped_memory_context
    ...
    if system_prompt_builder is not None:
        ...
        if scrna_claw_dir:
            builder_kwargs["scrna_claw_dir"] = scrna_claw_dir
