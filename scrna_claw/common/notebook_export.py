"""Notebook export helpers for standard ScrnaClaw analysis outputs."""
...
from scrna_claw.common.report import extract_method_name, load_result_json
...
def write_analysis_notebook(
    ...
    *,
    ...
    overview_lines = [
        "# ScrnaClaw Analysis Notebook",
        "",
        "This notebook was auto-generated from a standard ScrnaClaw analysis run.",
        "",
        f"- **Skill**: `{skill_alias}`",
        f"- **Method**: `{method}`",
...
"""
    ...
    nb.cells.append(
        new_markdown_cell(
            ...
            "- This notebook is intentionally generic so every ScrnaClaw skill can emit it without custom code.\n"
