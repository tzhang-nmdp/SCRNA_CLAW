"""Common report generation helpers for ScrnaClaw skills."""
...
DISCLAIMER = (
    "ScrnaClaw is a research and educational tool for multi-omics "
...
def write_result_json(
    ...
    Args:
        lineage: Optional list of upstream step records from a
                 :class:`~scrna_claw.common.manifest.PipelineManifest`.
    """
    output_dir = Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
