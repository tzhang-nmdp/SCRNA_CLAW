...
from scrna_claw.core.provider_registry import resolve_provider
...
def _resolve_llm_config() -> Tuple[str, str, str]:
    ...
    base_url, model, api_key = resolve_provider(
        ...
        model=os.getenv("SCRNA_CLAW_MODEL") or os.getenv("LLM_MODEL", ""),
...
def route_with_llm(query: str, skills: Dict[str, str], domain: str) -> Tuple[Optional[str], float]:
    ...
    Supports all providers configured in scrna_claw.core.provider_registry:
