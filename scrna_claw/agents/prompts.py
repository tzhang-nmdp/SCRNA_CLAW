"""Prompt templates for the ScrnaClaw research pipeline.

Inspired by EvoScientist's prompts.py — adapted for multi-omics analysis
workflows with ScrnaClaw's skill-based architecture.
"""
...
from scrna_claw.core.registry import SCRNA_CLAW_DIR
from scrna_claw.runtime.system_prompt import build_system_prompt

# =============================================================================
# Main orchestrator workflow
# =============================================================================

RESEARCH_PIPELINE_WORKFLOW = """# ScrnaClaw Research Pipeline Workflow
...
## Core Principles
- Use ScrnaClaw's existing analysis skills for all computational work.
...
4. **Execute** → coding-agent: Run ScrnaClaw skills according to the plan.
...
- Use coding-agent for all ScrnaClaw skill invocations.
...
RESEARCHER_INSTRUCTIONS = """You are a research assistant for the ScrnaClaw \
...
## Recommended Methods for ScrnaClaw
- Method name → ScrnaClaw skill: `skill-name` (--method option)
