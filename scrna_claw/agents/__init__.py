"""ScrnaClaw Multi-Agent Research Pipeline.

Integrates EvoScientist-inspired multi-agent architecture into ScrnaClaw,
...
Usage::
    ...
    from scrna_claw.agents import run_research_pipeline
