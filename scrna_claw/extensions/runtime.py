"""Runtime activation helpers for installable ScrnaClaw extensions."""
...
def build_extension_runtime_snapshot(
    ...
    *,
    ...
    output_style_packs = tuple(load_enabled_output_style_packs(scrna_claw_dir))
    agent_packs = tuple(load_enabled_agent_packs(scrna_claw_dir))
    workflow_packs = tuple(load_enabled_workflow_packs(scrna_claw_dir))
    hook_extensions = tuple(load_active_hook_extensions(scrna_claw_dir))
    tool_execution_hook_extensions = tuple(
        load_active_tool_execution_hook_extensions(scrna_claw_dir)
    )
...
def load_prompt_pack_runtime_context(
    ...
    *,
    ...
    header_lines = [
        ...
        "",
        "Enabled local prompt packs are active for this session. Core ScrnaClaw guardrails override them on conflict.",
    ]
