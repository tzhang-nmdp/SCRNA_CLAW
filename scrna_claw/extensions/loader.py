...
INSTALL_RECORD_FILENAME = ".scrna_claw-install.json"
EXTENSION_STATE_FILENAME = ".scrna_claw-extension-state.json"
...
def iter_extension_store_dirs(
    ...
    *,
    ...
    return [
        (extension_type, extension_store_dir(scrna_claw_dir, extension_type))
