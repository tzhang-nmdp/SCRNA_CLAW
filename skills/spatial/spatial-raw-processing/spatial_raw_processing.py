...
SKILL_DESCRIPTION = (
    ...
    "standardized ScrnaClaw outputs and downstream handoff to spatial-preprocess."
)
DEFAULT_METHOD = "st_pipeline"
DEFAULT_EXP_NAME = "scrna_claw_spatial_raw"
STPIPELINE_DEFAULTS = {
    "threads": 4,
...
def main() -> None:
    ...
    if args.demo:
        ...
        upstream_meta.setdefault("runner", "scrna_claw demo")
