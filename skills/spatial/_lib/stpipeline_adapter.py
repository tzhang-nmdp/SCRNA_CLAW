...
This module keeps the ScrnaClaw wrapper honest about what the upstream tool
...
def resolve_stpipeline_environment(
    *,
    ...
    """Resolve how ScrnaClaw should invoke st_pipeline."""

    candidate_repo = repo_path or os.getenv("SCRNA_CLAW_ST_PIPELINE_REPO")
    if candidate_repo:
    ...
    raise DependencyError(
        ...
        "with `--stpipeline-repo <repo_root>` / SCRNA_CLAW_ST_PIPELINE_REPO set "
...
def run_stpipeline(
    *,
    ...
    """Run upstream st_pipeline and return standardized ScrnaClaw metadata."""
    ...
    _json_dump(upstream_dir / "scrna_claw_stpipeline_run.json", metadata)
