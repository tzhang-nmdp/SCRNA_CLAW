...
def _build_visualization_recipe(
    ...
    *,
    ...
    return VisualizationRecipe(
        ...
        description=(
            "Default ScrnaClaw raw-processing story plots: coordinate-level raw "
...
def write_reproducibility(
    ...
    *,
    ...
    write_repro_requirements(
        output_dir,
        ["scrna_claw", "anndata", "numpy", "pandas", "scipy", "matplotlib"],
    )
    ...
    *,
    ...
    body_lines.extend(
        [
            ...
            "- ScrnaClaw retains barcode coordinates from the IDs file even when some barcodes have zero detected molecules, so downstream neighborhood or masking steps can stay coordinate-aware.",
