...
def _build_integration_visualization_recipe(
    ...
    return VisualizationRecipe(
        ...
        description=(
            "Default ScrnaClaw integration story plots built from existing integration and "
...
def get_demo_data() -> tuple:
    ...
    main_runner = _PROJECT_ROOT / "scrna_claw.py"
    if not main_runner.exists():
        raise FileNotFoundError(f"ScrnaClaw runner not found at {main_runner}")
