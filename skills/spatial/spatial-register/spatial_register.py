...
def _build_register_visualization_recipe(adata, summary: dict[str, Any], context: dict[str, Any]) -> VisualizationRecipe:
    ...
    return VisualizationRecipe(
        ...
        description=(
            "Default ScrnaClaw registration story plots: slice overlays before and after alignment, "
    ...
    *,
    ...
    if not disparity_df.empty:
        ...
        body_lines.extend(
            [
                "",
                "Current ScrnaClaw PASTE reporting uses a transport-matrix-derived alignment score proxy for non-reference slices.",
            ]
        )
