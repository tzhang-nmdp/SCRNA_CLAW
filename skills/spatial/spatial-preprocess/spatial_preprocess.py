...
def _build_preprocess_visualization_recipe(adata, summary: dict[str, Any], context: dict[str, Any]) -> VisualizationRecipe:
    ...
    return VisualizationRecipe(
        ...
        description=(
            "Default ScrnaClaw preprocessing story plots: clustering overview, "
    ...
    *,
    ...
    body_lines.extend(
        [
            ...
            "- ScrnaClaw reports requested, computed, used, and suggested PC counts separately so graph construction choices stay auditable instead of being hidden behind Scanpy internals.",
