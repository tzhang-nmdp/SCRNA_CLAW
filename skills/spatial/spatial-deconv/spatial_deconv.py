...
def _build_deconv_visualization_recipe(
    ...
    return VisualizationRecipe(
        ...
        description=(
            "Default ScrnaClaw deconvolution story plots: proportion overviews, "
    ...
    *,
    ...
    lines.extend(
        [
            ...
            "- Assignment margin (`top1 - top2`) is the standard ScrnaClaw uncertainty proxy for ambiguous spots.",
        ]
    )
