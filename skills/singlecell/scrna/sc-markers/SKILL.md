...
- With it: ScrnaClaw exports cluster-level marker tables, summary figures, and a downstream-ready `processed.h5ad`.
- Why ScrnaClaw: it keeps marker ranking separate from replicate-aware condition DE.
