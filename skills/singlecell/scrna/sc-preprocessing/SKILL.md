...
- With it: one run produces a stable normalized, PCA-ready AnnData plus standard ScrnaClaw outputs.
- Why ScrnaClaw: the wrapper reuses shared single-cell canonicalization, QC, and filtering logic, and keeps a stable downstream contract.
