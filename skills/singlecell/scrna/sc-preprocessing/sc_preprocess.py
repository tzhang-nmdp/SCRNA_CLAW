...
def run_seurat_preprocessing(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="scrna_claw_sc_preprocess_") as tmpdir:
        tmpdir = Path(tmpdir)
...
def _build_preprocess_visualization_recipe(adata, summary: dict, context: dict) -> VisualizationRecipe:
    ...
    return VisualizationRecipe(
        ...
        description=f"Default ScrnaClaw preprocessing gallery for method '{summary.get('method', '')}'.",
        plots=plots,
    )
    ...
    *,
    ...
    body_lines.extend(
        [
            ...
            "- `figures/` — standard ScrnaClaw base preprocessing gallery.",
