...
def main():
    ...
    result_data = {
        "method": method,
        "params": params,
        "input_contract": adata.uns.get("scrna_claw_input_contract", {}),
