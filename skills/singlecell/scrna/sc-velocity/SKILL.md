...
- Why ScrnaClaw: one wrapper captures velocity figures, latent-time summaries, and method provenance.
...
Current ScrnaClaw `sc-velocity` always:
...
- The standard ScrnaClaw upstream path is now `sc-velocity-prep` -> `sc-velocity`.
