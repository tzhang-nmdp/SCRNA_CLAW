...
def test_demo_processed_contract(tmp_path):
    ...
    assert adata.uns["scrna_claw_matrix_contract"]["X"] == "raw_counts"
    assert adata.uns["scrna_claw_matrix_contract"]["layers"]["counts"] == "raw_counts"
    assert adata.uns["scrna_claw_input_contract"]["domain"] == "singlecell"
