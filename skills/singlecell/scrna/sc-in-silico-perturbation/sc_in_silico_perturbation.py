...
from scrna_claw.common.report import generate_report_footer, generate_report_header, write_output_readme, write_result_json
...
def _run_sctenifoldknk(df: pd.DataFrame, args: argparse.Namespace, output_dir: Path) -> pd.DataFrame:
    with tempfile.TemporaryDirectory(prefix="scrna_claw_tenifold_") as tmpdir:
