...
def main() -> None:
    ...
    output_adata.uns.setdefault("scrna_claw_velocity_prep", {})
    output_adata.uns["scrna_claw_velocity_prep"].update(artifact_info)
    output_adata.uns["scrna_claw_velocity_prep"]["used_base_h5ad"] = used_base
