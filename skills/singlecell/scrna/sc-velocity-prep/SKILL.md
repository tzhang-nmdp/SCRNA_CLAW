    ...
    param_hints:
      velocyto:
        ...
        tips:
          ...
          - "--base-h5ad: merge spliced/unspliced layers back into an existing ScrnaClaw object."
      starsolo:
...
You are **SC Velocity Prep**, a specialized ScrnaClaw agent for producing
...
- **Why ScrnaClaw**: it keeps the heavy upstream extraction step separate from
...
> **Current ScrnaClaw behavior**: the wrapper keeps velocity extraction
