...
def test_prefers_counts_layer_and_gene_symbol_column(tmp_output, tmp_path):
    ...
    assert qc_h5ad.uns["scrna_claw_input_contract"]["standardized"] is True
    assert qc_h5ad.uns["scrna_claw_matrix_contract"]["X"] == "raw_counts"
    assert qc_h5ad.uns["scrna_claw_matrix_contract"]["raw"] == "raw_counts_snapshot"
