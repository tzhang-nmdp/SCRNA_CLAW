...
- Why ScrnaClaw: one contract bundles PAGA, diffusion map, DPT, and export tables.
...
Current ScrnaClaw `sc-pseudotime` runs either:
...
- `palantir` currently requires an explicit root choice in ScrnaClaw.
