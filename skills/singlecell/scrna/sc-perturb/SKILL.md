...
- If the input AnnData does not already contain perturbation labels in `adata.obs`, prepare them upstream first; ScrnaClaw now provides `sc-perturb-prep` for expression data plus barcode-to-guide mapping files.
