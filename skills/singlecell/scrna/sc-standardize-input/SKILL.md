...
description: >-
  ...
  contract so downstream ScrnaClaw scRNA skills can use it safely.
version: 0.1.0
author: ScrnaClaw
license: MIT
...
You are **SC Standardize Input**, the ScrnaClaw skill for explicitly exporting
...
6. records provenance and matrix semantics in `adata.uns['scrna_claw_input_contract']` and `adata.uns['scrna_claw_matrix_contract']`
...
- users provide arbitrary `.h5ad` files from outside ScrnaClaw
