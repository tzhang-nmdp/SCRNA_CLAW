...
def merge_velocity_layers(base_adata, velocity_adata):
    ...
    merged.uns.setdefault("scrna_claw_velocity_prep", {})
    merged.uns["scrna_claw_velocity_prep"]["shared_cells"] = int(merged.n_obs)
    merged.uns["scrna_claw_velocity_prep"]["shared_genes"] = int(merged.n_vars)
    return merged
