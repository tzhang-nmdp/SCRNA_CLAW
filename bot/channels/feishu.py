"""
Feishu (Lark) channel implementation for ScrnaClaw.
...
logger = logging.getLogger("scrna_claw.channel.feishu")
...
class FeishuChannel(Channel):
    ...
    def run_sync(self) -> None:
        ...
        logger.info(
            f"Starting ScrnaClaw Feishu bot "
        ...
        print("ScrnaClaw Feishu bot is running. Press Ctrl+C to stop.")
    ...
    def _should_respond_in_group(self, text: str, mentions: list) -> bool:
        ...
        if any(v in text for v in self._REQUEST_VERBS):
            return True
        if re.match(r"^(scrna_claw|spatialclaw|bot|助手|智能体)[\s,:，：]", text, re.IGNORECASE):
            return True
        return False
            ...
            if text:
                ...
                content_blocks.append({
                    ...
                    "text": (
                        ...
                        "transcriptomics platform. Then suggest which ScrnaClaw skills "
