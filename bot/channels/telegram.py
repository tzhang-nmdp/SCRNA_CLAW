"""
Telegram channel implementation for ScrnaClaw.
...
logger = logging.getLogger("scrna_claw.channel.telegram")
...
class TelegramChannel(Channel):
    ...
    def run_polling(self) -> None:
        ...
        logger.info(
            f"Starting ScrnaClaw Telegram bot "
            f"(provider: {core.LLM_PROVIDER_NAME}, model: {core.SCRNA_CLAW_MODEL})"
        )
        logger.info(f"ScrnaClaw directory: {core.SCRNA_CLAW_DIR}")
        ...
        print("ScrnaClaw Telegram bot is running. Press Ctrl+C to stop.")
        try:
            loop.run_forever()
    ...
    async def _cmd_start(self, update, context) -> None:
        await update.message.reply_text(
            "Welcome to ScrnaClaw -- multi-omics analysis at your fingertips!\n\n"
            ...
            "ScrnaClaw is a research tool, not a medical device. "
    ...
    async def _cmd_demo(self, update, context) -> None:
        ...
        try:
            ...
            reply = await core.llm_tool_loop(
                ...
                f"Run the {skill} demo using the scrna_claw tool with mode='demo'.",
    ...
    async def _cmd_status(self, update, context) -> None:
        ...
        skills_dir = core.SCRNA_CLAW_DIR / "skills"
        skill_count = sum(
    ...
    async def _cmd_health(self, update, context) -> None:
        from bot import core
        checks = []
        if core.SCRNA_CLAW_PY.exists():
            checks.append("ScrnaClaw CLI: OK")
        else:
            checks.append("ScrnaClaw CLI: MISSING")
            ...
            if caption:
                ...
                content_blocks.append({
                    ...
                    "text": (
                        ...
                        "transcriptomics platform. Then suggest which ScrnaClaw analysis "
        ...
        try:
            ...
            try:
                upload_proc = await asyncio.create_subprocess_exec(
                    sys.executable, str(core.SCRNA_CLAW_PY), "upload",
                    "--input", str(tmp_path),
            ...
            if caption:
                ...
                parts.append(
                    ...
                    f"run the appropriate ScrnaClaw skill using mode='file'. "
