#!/usr/bin/env python3
"""Validate all ScrnaClaw skill scripts against the SkillProtocol conventions.
...
from scrna_claw.core.registry import OmicsRegistry, SKILLS_DIR
from scrna_claw.core.skill_protocol import validate_skill_module
...
def main():
    parser = argparse.ArgumentParser(description="Validate ScrnaClaw skill conventions")
