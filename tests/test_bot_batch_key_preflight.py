...
def test_execute_scrna_claw_pauses_before_running_when_batch_key_missing(tmp_path, monkeypatch):
...
def test_auto_prepare_sc_batch_integration_runs_upstream_workflow(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(core, "execute_scrna_claw", _fake_execute)
