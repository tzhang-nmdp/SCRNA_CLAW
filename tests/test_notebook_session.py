...
layer that enables the coding-agent to run ScrnaClaw skill functions
...
class TestNotebookToolsConfig:
    ...
    def test_notebook_tools_in_registry(self):
        ...
        from scrna_claw.agents.tools import build_tool_registry
    ...
    def test_skill_search_returns_results(self):
        ...
        from scrna_claw.agents.tools import skill_search
