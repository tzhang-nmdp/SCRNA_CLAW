...
class TestAgentConfig:
    ...
    def test_config_yaml_exists(self):
        """config.yaml must exist in scrna_claw/agents/."""
        config_path = Path(__file__).parent.parent / "scrna_claw" / "agents" / "config.yaml"
...
class TestPrompts:
    ...
    def test_imports(self):
        ...
        from scrna_claw.agents.prompts import (
        ...
        assert "ScrnaClaw" in RESEARCH_PIPELINE_WORKFLOW
        assert "reviewer" in REVIEWER_CHECKLIST.lower()

    def test_get_system_prompt(self):
        """get_system_prompt() returns a non-empty prompt."""
        from scrna_claw.agents.prompts import get_system_prompt
        prompt = get_system_prompt()
        assert len(prompt) > 100
        assert "ScrnaClaw" in prompt
    ...
    def test_get_researcher_prompt_has_date(self):
        ...
        from scrna_claw.agents.prompts import get_researcher_prompt
    ...
    def test_build_prompt_refs(self):
        ...
        from scrna_claw.agents.prompts import build_prompt_refs
...
class TestIntake:
    ...
    def test_intake_result_structure(self):
        ...
        from scrna_claw.agents.intake import IntakeResult
        result = IntakeResult()
    ...
    def test_extract_geo_accessions(self):
        ...
        from scrna_claw.agents.intake import _extract_geo_accessions
    ...
    def test_extract_organism_human(self):
        ...
        from scrna_claw.agents.intake import _extract_organism
    ...
    def test_extract_technology(self):
        ...
        from scrna_claw.agents.intake import _extract_technology
    ...
    def test_extract_tissue(self):
        ...
        from scrna_claw.agents.intake import _extract_tissue
    ...
    def test_pdf_to_markdown(self):
        ...
        from scrna_claw.agents.intake import _pdf_to_markdown
    ...
    def test_prepare_intake_mode_a(self):
        ...
        from scrna_claw.agents.intake import prepare_intake
...
class TestSlashCommand:
    ...
    def test_pipeline_commands_in_slash_commands(self):
        from scrna_claw.interactive._constants import SLASH_COMMANDS
