...
from scrna_claw.core.provider_registry import PROVIDER_PRESETS


def test_build_llm_timeout_uses_defaults(monkeypatch):
    monkeypatch.delenv("SCRNA_CLAW_LLM_TIMEOUT_SECONDS", raising=False)
    monkeypatch.delenv("SCRNA_CLAW_LLM_CONNECT_TIMEOUT_SECONDS", raising=False)
...
def test_build_llm_timeout_respects_env(monkeypatch):
    monkeypatch.setenv("SCRNA_CLAW_LLM_TIMEOUT_SECONDS", "45")
    monkeypatch.setenv("SCRNA_CLAW_LLM_CONNECT_TIMEOUT_SECONDS", "3")
...
def test_init_passes_timeout_to_async_openai(monkeypatch):
    ...
    monkeypatch.setenv("SCRNA_CLAW_MEMORY_ENABLED", "false")
    monkeypatch.setenv("SCRNA_CLAW_LLM_TIMEOUT_SECONDS", "30")
    monkeypatch.setenv("SCRNA_CLAW_LLM_CONNECT_TIMEOUT_SECONDS", "5")
...
def test_pipeline_openai_path_receives_shared_timeout(monkeypatch):
    ...
    monkeypatch.setenv("SCRNA_CLAW_LLM_TIMEOUT_SECONDS", "25")
    monkeypatch.setenv("SCRNA_CLAW_LLM_CONNECT_TIMEOUT_SECONDS", "4")
...
def test_pipeline_anthropic_path_receives_total_timeout(monkeypatch):
    ...
    monkeypatch.setenv("SCRNA_CLAW_LLM_TIMEOUT_SECONDS", "40")
    monkeypatch.setenv("SCRNA_CLAW_LLM_CONNECT_TIMEOUT_SECONDS", "7")
