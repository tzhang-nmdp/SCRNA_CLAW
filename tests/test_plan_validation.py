...
from scrna_claw.agents.plan_validation import validate_plan_file, validate_plan_text
...
"""
    ...
    assert result.valid is False
    assert "Missing stage detail: ScrnaClaw skill selection." in result.errors
