...
from scrna_claw.interactive._scrna_claw_actions import (
    build_skills_catalog_view,
    format_skills_catalog_plain,
    list_registered_skill_names,
    run_skill_command,
)
from scrna_claw.interactive._skill_run_support import SkillRunCommandArgs
...
def test_build_skills_catalog_view_uses_root_script_metadata(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "scrna_claw.interactive._scrna_claw_actions.load_scrna_claw_script",
        lambda: fake_script,
    )
...
def test_format_skills_catalog_plain_renders_filter_and_missing_state():
    from scrna_claw.interactive._scrna_claw_actions import SkillsCatalogView
    ...
    assert "ScrnaClaw Skills (0 total)" in text
...
def test_format_skills_catalog_plain_renders_sections():
    ...
    assert "ScrnaClaw Skills (2 total)" in text
