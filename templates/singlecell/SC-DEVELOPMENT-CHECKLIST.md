...
Use this checklist before saying a single-cell skill is aligned with ScrnaClaw.

- [ ] output object is named `processed.h5ad`
- [ ] `scrna_claw_input_contract` is written
- [ ] `scrna_claw_matrix_contract` is written
