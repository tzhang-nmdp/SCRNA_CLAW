...
This file defines the canonical matrix semantics for ScrnaClaw scRNA skills.
...
- `adata.X`
  ...
  - must be declared in `adata.uns["scrna_claw_matrix_contract"]["X"]`
...
Minimum `scrna_claw_matrix_contract` structure:
